...
public class WrapMapper {
     ...
     * @return the wrapper
     */
    public static <E> Wrapper<E> fail(ErrorCodeEnum codeEnum) {
        return wrap(Wrapper.FAIL_STATUS, codeEnum.getMsg(), null);
    }
    ...
    public static <E> Wrapper<E> error(String message) {
        return wrap(Wrapper.ERROR_STATUS, StringUtils.isEmpty(message) ? Wrapper.ERROR_MESSAGE : message, null);
    }
