...
import com.somnus.microservice.gateway.web.balancer.VerGrayLoadBalancer;
 ...
 */
@Slf4j
public class VerGrayReactiveLoadBalancerClientFilter implements GlobalFilter, Ordered {
    ...
    public VerGrayReactiveLoadBalancerClientFilter(LoadBalancerClientFactory clientFactory, GatewayLoadBalancerProperties properties) {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        log.info("gatewayRequestUrl:[{}]->Scheme:[{}]->gatewaySchemePrefix:[{}]", url, url != null ? url.getScheme() : "", schemePrefix);
    ...
    private Mono<Response<ServiceInstance>> choose(ServerWebExchange exchange) {
        ...
        VerGrayLoadBalancer loadBalancer = new VerGrayLoadBalancer(clientFactory.getLazyProvider(Objects.requireNonNull(uri).getHost(), ServiceInstanceListSupplier.class), uri.getHost());
